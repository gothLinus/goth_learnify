                ...
                <form class="mt-6 sm:mt-8 space-y-4" method="post" action="/users/login">
                    ...
                    <div class="flex flex-wrap items-center justify-between gap-4">
                        ...
                        <div class="text-sm sm:text-base">
                            <a href="/forgot-password" class="text-cyan-400 hover:underline font-semibold">
                    ...
                    <p class="text-gray-800 text-sm sm:text-base !mt-6 sm:!mt-8 text-center">Don't have an account? <a
                                href="/register"
                                class="text-cyan-400 hover:underline ml-1 whitespace-nowrap font-semibold">Register
                            here</a></p>
                </form>
                <div class="mt-6 sm:mt-8">
                    <div class="flex items-center">
                    ...
                    <div class="flex justify-center mt-4 gap-4">
                        <a href="/login/google"
                           class="w-1/3 py-2 flex items-center justify-center text-sm sm:text-base rounded-lg bg-gray-100 hover:bg-gray-200 text-gray-800 shadow focus:outline-none">
