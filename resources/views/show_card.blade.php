<x-layout>
    ...
    <span>
        {{ $card->time}}
                ...
                <button @click="start()" class="px-3 py-1 bg-green-500 text-white rounded-lg hover:bg-green-700">
                    Start
                </button>
                <button @click="stop()" class="px-3 py-1 bg-yellow-500 text-white rounded-lg hover:bg-yellow-700">
                    Stop
                </button>
                <button @click="reset()" class="px-3 py-1 bg-red-500 text-white rounded-lg hover:bg-red-700">Reset
                </button>
            </div>
        </div>
        ...
        <div class="flex justify-between items-center mt-6">
            ...
            <a href="/card/edit/{{$card->id}}" class="flex items-center text-blue-500 hover:text-blue-700">
